...
To avoid reflecting user-controlled data, you should properly sanitize and escape any user input before outputting it. In this case, you can use the `htmlspecialchars()` function to encode special characters in the user-controlled data. Here's the updated code:
