...
To avoid reflecting user-controlled data, you should properly escape the value of `$pPage['title']`. Use the `htmlspecialchars` function to prevent any HTML special characters from being interpreted as HTML tags or entities.
