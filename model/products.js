...
This code snippet simply echoes out HTML markup. To avoid reflecting user-controlled data, we separate the HTML markup from the PHP code. By using `\n` to add line breaks, we ensure the generated HTML is properly formatted.
		<title>{$pPage[ 'title' ]}</title>
