...
To remediate the security vulnerability and avoid reflecting user-controlled data, you can remove the echo statement and directly write the HTML code as follows:
...
By removing the echo statement and directly writing the HTML code, you ensure that user-controlled data is not being reflected in the output.
		<title>{$pPage[ 'title' ]}</title>
