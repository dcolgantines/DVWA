...
To avoid reflecting user-controlled data directly in the HTML, you should properly sanitize and escape it before outputting. The `htmlspecialchars()` function can be used to achieve this. Here's the updated code:
...
In the code above, `htmlspecialchars()` is used to escape any special characters in the `$pPage['title']` value, ensuring that it is displayed as literal text and not interpreted as HTML.
