...
$sourceFilePath = DVWA_WEB_PAGE_TO_ROOT . "vulnerabilities/{$id}/source/{$security}.php";
$source = "";
...
$jsSourceFilePath = DVWA_WEB_PAGE_TO_ROOT . "vulnerabilities/{$id}/source/{$security}.js";

if (file_exists($jsSourceFilePath)) {
    $js_source = file_get_contents($jsSourceFilePath);
    $js_html = "
