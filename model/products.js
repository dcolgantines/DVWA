...
To avoid constructing the path from user-controlled data, you should validate the input and use a whitelist to prevent any unwanted characters or values.
...
In this code, we create an array of allowed IDs, and then check if the provided `id` exists in the array. If it does, we proceed with the code execution. Otherwise, you can handle the case of an invalid `id`, such as redirecting the user or returning an error message.
		case "open_redirect" :
