...
To avoid reflecting user-controlled data directly in the HTML, you can use htmlspecialchars() function to encode the title variable. Here's the updated code snippet:
...
By using htmlspecialchars(), any special characters in the title will be properly encoded, reducing the risk of XSS (Cross-Site Scripting) attacks.
